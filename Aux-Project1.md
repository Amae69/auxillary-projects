...
Here is a link: https://youtu.be/9aU6G4qWt7o  of a screen record demo of how i onboard multiple users to a linux server using shell script 
...
- ### Create a csv file named **names.csv** and copy the below names into it using vi editor
...
- ### Create a file named **"id_rsa"** for my **private key** copy and paste the below key into it using vi editor
  ```
